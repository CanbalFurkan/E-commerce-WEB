    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="salesmanager.php"><i class="fa fa-desktop "></i>Dashboard</a>
                </li>
                <li>
        ...
        <div id="page-inner">
            ...
            if(isset($_POST['update']))
            {
                ...
                if(empty($sale)) {
                    ...
                    if(empty($sale)) {
                        echo "<font color='red'>Please enter the sale amount.</font><br/>";
                    }
                }
                    //updating the table
                    $result = mysqli_query($mysqli, "UPDATE product_registration SET p_discount='$sale' WHERE p_id=$id");
            ...
            <form name="form1" method="post" action=<?php echo"salesedit.php?id=$id" ?>>
                <table border="0">
                    <tr>
                        <td>Sale</td>
