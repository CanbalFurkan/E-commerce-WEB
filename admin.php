        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Click to add a category</label>
                        <a href="blankC.php" target="_blank" class="btn btn-danger btn-lg btn-block">New Category</a>
                    </div>
                    <div class="col-md-4">
                        <label>Click to add a product</label>
                        <a href="blank.php" target="_blank" class="btn btn-danger btn-lg btn-block">New Product</a>
...
$result = mysqli_query($mysqli, "SELECT * FROM product_registration ORDER BY p_id DESC");
?>
                <table width='80%' border=0>
                    ...
                    while($res = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>".$res['p_quantity']."</td>";
                        echo "<td>".$res['p_cost']."</td>";
                        echo "<td>".$res['p_discount']."</td>";
                        echo "<td>".$res['p_mid']."</td>";
                        echo "<td>".$res['p_description']."</td>";
                        echo "<td>".$res['p_warranty']."</td>";
                        echo "<td><a href=\"edit.php?id=$res[p_id]\">Edit</a> | <a href=\"delete.php?id=$res[p_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                    }
                    ?>
                </table>
